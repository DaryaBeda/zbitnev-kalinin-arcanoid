...
//        
//        CollidedObject collidedBall = new CollidedObject(ball, new Point2D.Double(50, 33), CollidedObject.SIDE_BOTTOM, (Shape) ballShape);
//        CollidedObject collidedBrick = new CollidedObject(brick, new Point2D.Double(50, 50), CollidedObject.SIDE_TOP, (Shape) brickShape);
//        
