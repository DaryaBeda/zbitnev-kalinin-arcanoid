...
//        
//        CollidedObject collidedBallLeft = new CollidedObject(ballLeft, new Point2D.Double(5, 64), CollidedObject.SIDE_BOTTOM, (Shape) ballLeftShape);
//        CollidedObject collidedBallCenter = new CollidedObject(ballCenter, new Point2D.Double(40, 64), CollidedObject.SIDE_BOTTOM, (Shape) ballCenterShape);
//        CollidedObject collidedBallRight = new CollidedObject(ballRight, new Point2D.Double(80, 64), CollidedObject.SIDE_BOTTOM, (Shape) ballRightShape);
//        CollidedObject collidedPaddle = new CollidedObject(paddle, new Point2D.Double(0, 80), CollidedObject.SIDE_TOP, (Shape) paddleShape);
//        
